    ...
    try:
        ...
        if args.command == "ask":
            ...
            try:
                ...
                if is_tty:
                    # Clear the "Thinking..." indicator (11 chars + some buffer)
                    sys.stderr.write("\r" + " " * 12 + "\r")
                    sys.stderr.flush()
            ...
            if result.tool_results:
                print()  # Add a newline between tool results and the answer
